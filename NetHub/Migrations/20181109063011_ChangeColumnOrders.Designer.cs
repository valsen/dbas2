...
namespace NetHub.Migrations
{
    ...
    [Migration("20181109063011_ChangeColumnOrders")]
    partial class ChangeColumnOrders
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetHub.Models.AgeFilter", b =>
                {
                    b.Property<int>("ID")
                        .HasColumnName("id");
                    ...
                    b.HasKey("ID")
                        .HasName("pk_age_filters");

                    b.ToTable("age_filters");
                });
            ...
            modelBuilder.Entity("NetHub.Models.AgeFilter", b =>
                {
                    b.HasOne("NetHub.Models.Account", "Account")
                        .WithMany()
                        .HasForeignKey("ID")
                        .HasConstraintName("fk_age_filters_accounts_id")
